module Audio
  module FFmpeg
    ...
    # View the Command:
    #   Audio::FFmpeg.merge(["#{path}1.mp3", "#{path}2.mp3"], "1_2.mp3", "/Users/itsjimmyh/Desktop/rf_sounds/")
    # Run the Command:
    #   Audio::FFmpeg.merge(["#{path}1.mp3", "#{path}2.mp3"], "1_2.mp3", "/Users/itsjimmyh/Desktop/rf_sounds/", true)
    def FFmpeg.merge(files, output_file_name, output_path, run_flag=false)
    ...
    # View the Command:
    #   Audio::FFmpeg.split(input_file, output_file, "00:00:01.53", "00:00:02.59", "/Users/itsjimmyh/Desktop/rf_sounds/"
    # Run the Command
    #   Audio::FFmpeg.split(input_file, output_file, "00:00:01.53", "00:00:02.59", "/Users/itsjimmyh/Desktop/rf_sounds/", true)
    def FFmpeg.split(input, output_name, start_time, end_time, output_path, run_flag=false)
